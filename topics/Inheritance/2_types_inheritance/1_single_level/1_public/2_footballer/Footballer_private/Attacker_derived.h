...
public:
    ...
    //let me explain my idea. what happens if you inherit from base class which has private data and you want to inherit all memeber private/public in public mode

    string getname_derived() { return Footballer::getname();}
};
