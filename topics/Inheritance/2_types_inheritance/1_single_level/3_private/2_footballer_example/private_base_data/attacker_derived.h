...
class Attacker : private Footballer
{
...
public:
    ...
    friend ostream& operator<< (ostream& stream, Attacker &o);
    string getname_from_derived() {return Footballer::getname(); }
...
ostream& operator<< (ostream& stream, Attacker &o)
{
    stream << Footballer(o) << endl;
    return stream;
}